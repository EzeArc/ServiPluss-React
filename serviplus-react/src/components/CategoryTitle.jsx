export const CategoryTitle = ({ children, isChanging }) => {
  return (
    <h1 className="relative [font-weight:100] m-auto mb-10 tracking-[1px] font-tomaso text-xl sm:text-3xl max-w-full sm:max-w-xl text-center leading-snug flex justify-center items-center h-80 text-white">
      <svg
        className={`h-60 w-24 fill-current ${
          isChanging
      ...
      <div className="flex justify-center items-center flex-col gap-y-4 w-72 px-10">
        <svg
          className={`absolute ${
            isChanging
